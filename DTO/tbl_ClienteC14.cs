...
namespace ProjetoMVCC14.DTO
{
    class tbl_ClienteC14
    {
        ...
        public string Cpf_cliente
        {
            set
            {
                ...
                {
                    throw new Exception("O CPF nao pode ficar em branco!");
                }
        ...
        public string Nome_cliente
        {
            set
            {
                ...
                {
                    throw new Exception("O nome nao pode ficar em branco!");
                }
        ...
        public string Nome_mae
        {
            set
            {
                ...
                {
                    throw new Exception("O nome da mae nao pode ficar em branco!");
                }
